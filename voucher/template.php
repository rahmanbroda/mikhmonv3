...
if($getsprice == "2000"){ $color = "#1FCBF2";} // jika harga == "1000" maka warna = "#01579B"
elseif($getsprice == "3000"){ $color = "#F27253";}
elseif($getsprice == "5000"){ $color = "#FFC832";}
elseif($getsprice == "10000"){ $color = "#0D81E7";}
...
<img style="margin:5px 0 0 5px;" width="85" height="25" src="<?php echo $logo;?>" alt="logo">
</td>	
...
Buka browser dan ketik <?= $dnsname; ?> 
</div>
</td>	
...
<?php if($hotspotname=='Cijeruk.Net'){$nohp='Teh Dati 08997766004';}else{$nohp='Rahman 087784767197';}?>
<b><?php echo $nohp; ?></b>
</div>
</td>
</tr>
